...
en: espeak-data/en_dict
	...
	wc -l dictsource/en_list
dictsource/en_list: dictsource/en_rules ../cainteoir-english/data/reece/*.dict
	echo "//" > dictsource/en_list
	cd dictsource && ../src/espeak --compile=en && cd ..
	../cainteoir-engine/tests/dictionary.py ../cainteoir-english/data/reece --exception-dictionary > dictsource/en_list
dictsource/en_extra: dictsource/en_rules ../cainteoir-english/data/reece/*.dict
